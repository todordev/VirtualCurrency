...
CREATE TABLE IF NOT EXISTS `j4mtg_vc_accounts` (
...
CREATE TABLE IF NOT EXISTS `j4mtg_vc_currencies` (
...
CREATE TABLE IF NOT EXISTS `j4mtg_vc_partners` (
...
CREATE TABLE IF NOT EXISTS `j4mtg_vc_tmp` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `user_id` int(10) unsigned NOT NULL,
...
CREATE TABLE IF NOT EXISTS `j4mtg_vc_transactions` (
