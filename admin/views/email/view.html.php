...
class VirtualCurrencyViewEmail extends JViewLegacy
{
    /**
     * @var JDocumentHtml
     */
    ...
    protected function addToolbar()
    {
        ...
        $this->documentTitle = $isNew ? JText::_('COM_VIRTUALCURRENCY_ADD_EMAIL')
            : JText::_('COM_VIRTUALCURRENCY_EDIT_EMAIL');
