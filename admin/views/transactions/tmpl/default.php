...
?>
<form action="<?php echo JRoute::_('index.php?option=com_virtualcurrency&view=transactions'); ?>" method="post"
            ...
            <div id="filter-bar" class="btn-toolbar">
                <div class="filter-search btn-group pull-left">
                    ...
                    <input type="text" name="filter_search" id="filter_search" class="hasTooltip"
                           ...
                           title="<?php echo JText::_('COM_VIRTUALCURRENCY_SEARCH_IN_TRANSACTIONS_TOOLTIP'); ?>"/>
                </div>
