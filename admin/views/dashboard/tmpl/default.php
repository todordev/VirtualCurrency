...
<div class="row-fluid">
	...
	<div class="span4">
        ...
        <a href="http://itprism.com" target="_blank" title="<?php echo JText::_("COM_VIRTUALCURRENCY_PRODUCT");?>"><img src="../media/com_virtualcurrency/images/product_of_itprism.png" alt="<?php echo JText::_("COM_VIRTUALCURRENCY_PRODUCT");?>" /></a>
