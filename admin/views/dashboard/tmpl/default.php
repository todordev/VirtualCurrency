...
<div id="j-main-container" class="span10">
    ...
    <div id="j-main-container">
        ...
        <div class="span4">
            <a href="http://itprism.com/free-joomla-extensions/ecommerce-gamification/virtual-currency-accounts-manager"
               target="_blank"><img src="../media/com_virtualcurrency/images/logo.png"
                                    alt="<?php echo JText::_("COM_VIRTUALCURRENCY"); ?>"/></a>
            <a href="http://itprism.com" target="_blank"><img
                    src="../media/com_virtualcurrency/images/product_of_itprism.png"
                    alt="<?php echo JText::_("COM_VIRTUALCURRENCY_PRODUCT"); ?>"/></a>
