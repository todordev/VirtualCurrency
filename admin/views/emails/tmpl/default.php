...
<form action="<?php echo JRoute::_('index.php?option=com_virtualcurrency&view=emails'); ?>" method="post" name="adminForm"
      id="adminForm">
            ...
            <div id="filter-bar" class="btn-toolbar">
                <div class="filter-search btn-group pull-left">
                    ...
                    <input type="text" class="hasTooltip" name="filter_search" id="filter_search"
                           placeholder="<?php echo JText::_('COM_VIRTUALCURRENCY_SEARCH_IN_SUBJECT'); ?>"
                           value="<?php echo $this->escape($this->state->get('filter.search')); ?>"
                           title="<?php echo JText::_('COM_VIRTUALCURRENCY_SEARCH_IN_SUBJECT_TOOLTIP'); ?>"/>
                </div>
